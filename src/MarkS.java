...
public class MarkS extends JInternalFrame implements ActionListener {
    ...
    public MarkS(String reg) {
        super("MARKS OF BCA BATCH", false, true, false, true);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == jb1) {
            BCA frm = new BCA(regn,"First Semester marks",1);
            frmAdminMDI.desktop.add(frm);
            frm.setVisible(true);
        }
        if (e.getSource() == jb2) {
            BCA frm = new BCA(regn,"Second Semester marks",2);
            frmAdminMDI.desktop.add(frm);
            frm.setVisible(true);
        }
        if (e.getSource() == jb3) {
            BCA frm = new BCA(regn,"Third Semester marks",3);
            frmAdminMDI.desktop.add(frm);
            frm.setVisible(true);
        }
        if (e.getSource() == jb4) {
            BCA frm = new BCA(regn,"Forth Semester marks",4);
            frmAdminMDI.desktop.add(frm);
            frm.setVisible(true);
        }
        if (e.getSource() == jb5) {
            BCA frm = new BCA(regn,"Fifth Semester marks",5);
            frmAdminMDI.desktop.add(frm);
            frm.setVisible(true);
        }
        if (e.getSource() == jb6) {
            BCA frm = new BCA(regn,"Sixth Semester marks",6);
            frmAdminMDI.desktop.add(frm);
            frm.setVisible(true);
        }
        if (e.getSource() == jbc) {
